...
| **Vocabulary in Sentences** | 284 JLPT-leveled words (N3→N2) carrying you toward full coverage of daily-conversation vocabulary, every word taught inside a full example sentence (never a bare word list), with reading, part of speech, meaning, audio, and a fill-in-the-blank quiz mode. Pacing is handled by Review Session's spaced repetition rather than a fixed weekly list. |
