  ...
  container.appendChild(
    section(
      ...
      `<ol>
        ...
        <li><strong>Vocabulary depth.</strong> Speaking at Advanced Mid needs Advanced Mid words, not just Advanced Mid grammar. <a href="#/vocabulary">Vocabulary in Sentences</a> carries you from mid-N3 through N2 — 284 words and growing, every one taught inside a full sentence, never as a bare flashcard. JLPT levels here are only a convenient difficulty scale, not a study target — the real goal is words and structures you actually reach for in daily conversation.</li>
