  ...
  container.appendChild(
    section(
      ...
      `<ol>
        ...
        <li><strong>Vocabulary depth.</strong> Speaking at Advanced Mid needs Advanced Mid words, not just Advanced Mid grammar. <a href="#/vocabulary">Vocabulary in Sentences</a> carries you through N3 and N2 — 3,144 words, every one taught inside a full sentence, never as a bare flashcard. JLPT levels here are only a convenient difficulty scale, not a study target — the real goal is words and structures you actually reach for in daily conversation.</li>
