...
export function renderSettings(container) {
  container.appendChild(
    el("div", { class: "page-header" }, [el("h1", {}, "⚙️ Ajustes / Settings"), el("p", {}, "Voice, pacing, and your progress data.")])
  );
  ...
  card.appendChild(field("Voice preference (Mexican Spanish, es-MX)", genderSelect));

  card.appendChild(el("button", { class: "btn btn-sm", onclick: () => audioEngine.speak("Hola, mucho gusto en conocerte.") }, "🔊 Test voice"));
    ...
    el(
      "button",
      {
        ...
        onclick: () => {
          ...
          const a = el("a", { href: url, download: "mexican-spanish-tutor-progress.json" });
