...
export default function TeamPrayerPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <h1 className="mt-2 font-display text-3xl font-bold text-forest-900">Prayer Requests</h1>
      <p className="text-xs text-forest-900/50">祈りのリクエスト一覧</p>
      ...
      <Card className="mt-6 border-sunset-400/30 bg-sunset-50/60 p-4 text-sm text-forest-900/70">
        ...
        login, no real routing — this only shows prayer requests saved in this browser.
      </Card>

      <div className="mt-8">
        <h2 className="font-display text-lg font-bold text-forest-900">{hydrated ? prayers.length : "…"} requests</h2>
