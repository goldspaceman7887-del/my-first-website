...
export const metadata = { title: "Bible Studies & Events — Seed Tokyo" };
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="font-display text-3xl font-bold text-forest-900">Bible Studies & Events</h1>
          <p className="text-xs text-forest-900/50">イベント一覧</p>
          <p className="mt-1 text-forest-900/70">
            Bible studies, prayer nights, testimony nights, campus gatherings, and
            explore-faith circles across Tokyo.
          </p>
        </div>
